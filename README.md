...
| `colorScheme`            | The color scheme to use for all feedback forms, if undefined or null it will listen to values specified in the form configuration design settings if fixed to "light" or "dark" will force light or dark mode, if "system" will listen to the system color scheme | `'light' \| 'dark' \| 'system' \| null \| undefined` |
